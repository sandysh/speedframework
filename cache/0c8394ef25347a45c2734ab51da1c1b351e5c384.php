...
<script src="<?php echo e(asset('js/material-dashboard.js?v=2.1.1')); ?>"></script>
<script src="<?php echo e(asset('js/plugins/bootstrap-notify.js')); ?>"></script>
<?php if(Core\Session::has('success')): ?>
    <script>
        var msg = '<?php echo e(\Core\Session::show('success')); ?>'
        $.notify({
            title: 'success',
            message: msg,
        },{type: 'success'});
...
</html><?php /**PATH /home/vagrant/code/speed/views/layouts/app.blade.php ENDPATH**/ ?>